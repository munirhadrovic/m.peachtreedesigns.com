...
<html>
	<head>
        ...
        <title>Peach Tree Designs</title>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>" data-position="fixed">
			<h1>Powered by <a href="http://mobilegrows.com/" rel="external">MobileGrows</a> | <a href="http://www.peachtreedesigns.com/" rel="external">Desktop Site</a></h1>
		</div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
              ...
              <fieldset class="ui-grid-b" data-theme="<?php echo $theme ?>">
                  ...
                  <div class="ui-block-a"><a href="#myPopuptelephone" class="callfindmail ui-btn buttons-radius" data-rel="popup" data-transition="flow"><img src="img/call.png"></a></div>
              ...
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-right buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Products</a>
					</div>
				</div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-right buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Design Services</a>
                  </div>
              </div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-right buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Guest Book</a>
                  </div>
              </div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-right buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Gift Certifikates</a>
                  </div>
              </div>
		  </div>
		</div>
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu">
						<ul id="menu">
							...
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Products</a></li>
                            <li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Design Services</a></li>
                            <li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Guest Book</a></li>
                            <li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Gift Certifikates</a></li>
